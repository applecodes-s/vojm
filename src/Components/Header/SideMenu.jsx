                    ...
                    <div className="widget  ">
                        <div className="th-widget-about">
                            <div className="about-logo">
                                <Link to="/">
                                    <img src={process.env.PUBLIC_URL + "assets/img/logo2.svg"} alt="Tourm" />
                                </Link>
                            </div>
                        ...
                        <div className="recent-post-wrap">
                            <div className="recent-post">
                                <div className="media-img">
                                    <Link to="/blog/1">
                                        <img src={process.env.PUBLIC_URL + "assets/img/blog/recent-post-1-1.jpg"} alt="Blog Image" />
                                    </Link>
                                </div>
                            ...
                            <div className="recent-post">
                                <div className="media-img">
                                    <Link to="/blog/1">
                                        <img src={process.env.PUBLIC_URL + "assets/img/blog/recent-post-1-2.jpg"} alt="Blog Image" />
                                    </Link>
                                </div>
                                <div className="media-body">
                                    <div className="recent-post-meta">
